...
with advanced_settings_output:
    ...
    if tray_mode:
        ...
        tray_col_1, tray_col_2, tray_col_3 = st.columns(3)
        with tray_col_1:
            tray_inside_width = st.number_input(
                "Individual tray inside width (in)",
                min_value=0.01,
                value=9.9,
                step=0.05,
            )
...
with input_3d_1:
    basket_inside_length = st.number_input(
        "Tray inside length (in)" if tray_mode else "Basket inside length (in)",
    ...
    with PdfPages(pdf_buffer) as pdf:
        ...
        geometry_items = (
            [
                ...
                ("Individual tray inside width", f"{tray_inside_width:.2f} in"),
                ...
                ("Gap between adjacent trays", f"{inter_tray_gap:.2f} in"),
            ]
            if tray_mode else
            [
